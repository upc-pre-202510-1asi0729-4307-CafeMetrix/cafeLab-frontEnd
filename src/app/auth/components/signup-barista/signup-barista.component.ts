...
@Component({
  selector: 'app-signup-barista',
  templateUrl: './signup-barista.component.html',
  imports: [
    TranslatePipe,
    ReactiveFormsModule,
    MatFormField,
  ...
  styleUrls: ['./signup-barista.component.css']
})
export class SignupBaristaComponent implements OnInit {
