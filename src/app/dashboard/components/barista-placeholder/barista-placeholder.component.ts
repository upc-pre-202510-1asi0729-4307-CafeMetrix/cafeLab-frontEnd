...
@Component({
  selector: 'app-barista-placeholder',
  templateUrl: './barista-placeholder.component.html',
  styleUrls: ['./barista-placeholder.component.css']
})
export class BaristaHomeComponent implements OnInit {
  user: User = {} as User;
  ...
  loadUserData(): void {
    ...
    if (user) {
      this.user = user;
      console.log('Usuario cargado en dashboard barista:', this.user);
    } else {
